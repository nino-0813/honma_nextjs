    ...
    <div className="pt-20 animate-fade-in bg-white overflow-x-hidden w-full">
      ...
      <section className="pt-12 md:pt-16 pb-16 md:pb-24 bg-white relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <div className="mb-12 md:mb-16">
            ...
            <div className="w-44 md:w-72 h-px bg-yuunagi mx-auto" />
          </div>
      ...
      <section className="py-10 md:py-14 bg-secondary/30 relative w-full">
        <div className="w-full flex flex-col items-center justify-center px-6">
          <p className="text-[11px] md:text-xs tracking-[0.3em] text-yuunagi-ink font-medium uppercase mb-3 text-center">JOIN US</p>
          <h3 className="text-2xl md:text-4xl font-serif tracking-widest mb-4 text-center">OUR PROJECT</h3>
          <div className="w-12 h-px bg-yuunagi" />
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <FadeInSection>
              <div className="relative w-full bg-white rounded-2xl shadow-[0_15px_40px_-12px_rgba(0,0,0,0.18)] p-6 md:p-10">
                ...
                <div className="grid grid-cols-2 gap-3 md:gap-4">
                  {PARTNER_LOGOS.map((p) => {
                    const cellClass =
                      'aspect-[16/9] bg-white border border-gray-200 rounded-lg flex items-center justify-center p-4 hover:border-yuunagi-soft hover:shadow-sm transition-all';
                    const logo = (
                      // eslint-disable-next-line @next/next/no-img-element
                      <img
                        src={p.src}
            ...
            <FadeInSection>
              <div className="md:pl-2">
                <p className="text-[11px] md:text-xs tracking-[0.3em] text-yuunagi-ink font-medium uppercase mb-2">Project 01 — Ambassador</p>
                ...
                <ul className="space-y-4 md:space-y-5 text-sm md:text-[15px] text-gray-700 mb-5">
                  {[
                    ...
                    <li key={item.t} className="flex items-start gap-2.5">
                      <svg className="w-4 h-4 md:w-5 md:h-5 text-yuunagi flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24">
                ...
                <div className="bg-stone-50 rounded-xl p-4 md:p-5 mb-5">
                  ...
                  <div className="grid grid-cols-2 gap-y-2 gap-x-4 text-xs md:text-sm text-gray-700">
                    <div className="flex items-center gap-2"><span className="text-yuunagi-ink font-medium">春</span><span>田植え</span></div>
                    <div className="flex items-center gap-2"><span className="text-yuunagi-ink font-medium">夏</span><span>生き物調査・草刈り</span></div>
                    <div className="flex items-center gap-2"><span className="text-yuunagi-ink font-medium">秋</span><span>稲刈り・収穫体験</span></div>
                    <div className="flex items-center gap-2"><span className="text-yuunagi-ink font-medium">冬</span><span>新嘗祭・新米お届け</span></div>
                  </div>
                </div>
                <a
                  href="/contact"
                  className="inline-flex items-center gap-2 bg-primary text-white text-xs md:text-sm tracking-[0.2em] uppercase px-6 md:px-8 py-3 rounded-full hover:bg-yuunagi-ink transition-colors"
                >
                  パートナーズの相談をする
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <FadeInSection>
              <div className="md:order-1 order-2">
                <p className="text-[11px] md:text-xs tracking-[0.3em] text-yuunagi-ink font-medium uppercase mb-2">Project 02 — Biodiversity</p>
                <h4 className="text-xl md:text-2xl font-serif font-semibold mb-2 leading-snug">
                  佐渡Kids生きもの調査隊
                </h4>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-center">
            ...
            <FadeInSection className="md:col-span-5">
              <div className="md:pl-2">
                <p className="text-[11px] md:text-xs tracking-[0.3em] text-yuunagi-ink font-medium uppercase mb-2">Project 03 — Crowdfunding</p>
                <h4 className="text-xl md:text-2xl font-serif font-semibold mb-2 leading-snug">
                  佐渡の小学生と世界一へ！
                </h4>
                <p className="text-sm md:text-[15px] font-medium text-yuunagi-ink mb-4">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 bg-yuunagi-ink text-white text-xs md:text-sm tracking-[0.2em] uppercase px-6 md:px-8 py-3 rounded-full hover:bg-yuunagi-ink transition-colors"
                  >
                    プロジェクトの詳細を見る
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
