            ...
            <tbody className="divide-y divide-gray-100">
              {transactions.map((transaction, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <span
                      className={`text-xs px-2 py-1 rounded ${
                        transaction.type === 'payment' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-600'
                      }`}
                    >
                  ...
                  <td className={`px-6 py-4 text-right font-medium ${transaction.amount > 0 ? 'text-green-600' : 'text-red-600'}`}>
