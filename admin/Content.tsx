              ...
              <tbody className="divide-y divide-gray-100">
                {filteredContent.map((content, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span className="text-gray-600">{getContentTypeLabel(content.type)}</span>
                    </td>
                    <td className="px-6 py-4">
                      <span
                        className={`inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-medium border ${getContentStatusColor(content.status)}`}
                      >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        <Link href={`/admin/content/${content.id}`} className="opacity-0 group-hover:opacity-100 transition-opacity">
