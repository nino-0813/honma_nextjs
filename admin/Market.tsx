  ...
  return (
    <div className="space-y-6">
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-800">マーケットチャネルを管理して、商品を複数の販売場所で販売できます。</p>
      </div>
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${channel.status === 'active' ? 'bg-green-100' : 'bg-gray-100'}`}>
                  {channel.type === 'online' ? (
