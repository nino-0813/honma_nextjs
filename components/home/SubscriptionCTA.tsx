      ...
      <div className="max-w-[1500px] mx-auto px-5 md:px-10">
        ...
        <div className="mx-auto mt-6 max-w-3xl text-center">
          <FadeIn delay={80}>
            ...
            <div className="mt-8 flex flex-col gap-6 text-sm leading-[2] text-gray-600 md:text-base">
        ...
        <FadeIn delay={140}>
          <div className="mx-auto mt-12 aspect-[16/9] max-w-6xl overflow-hidden bg-dim md:mt-16 md:aspect-[16/7]">
            ...
            <img src="/images/home/satoyama-toyota.webp" alt="佐渡の豊田集落の里山風景" loading="lazy" className="h-full w-full object-cover" />
          </div>
        </FadeIn>
        ...
        <div className="mt-12 text-center">
          <Link
            ...
            className="inline-flex min-h-12 items-center gap-2 rounded-full border border-primary bg-white px-10 py-4 text-sm font-medium text-primary transition-colors hover:bg-primary hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
          >
            定期便をはじめる
